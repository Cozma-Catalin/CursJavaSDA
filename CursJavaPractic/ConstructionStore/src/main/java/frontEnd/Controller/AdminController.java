...
public class  AdminController {
    ...
    public String updateScrewdriverPrice(@RequestParam double price,String brand){
    ...
    public String updateScrewdriverQuantity(@RequestParam double quantity,String brand){
    ...
    @DeleteMapping("/deleteScrewdriverByBrand")
    public String deleteScrewdriverByBrand(@RequestParam String brand){
    ...
    public ResponseEntity<DepartmentDTO> findDepartmentByName(@RequestParam String name) {
    ...
    public String renameDepartment(@RequestParam String newName, String name) {
